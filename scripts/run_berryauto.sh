...
# Ensure our custom BerryAuto DKMS Audio module is loaded
# (This provides the 'hw:BerryAutoAudio' devices for PulseAudio/PipeWire)
sudo modprobe snd-berryauto 2>/dev/null || true
